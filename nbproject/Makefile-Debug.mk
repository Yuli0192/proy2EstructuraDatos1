...
${OBJECTDIR}/asiento.o: asiento.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/asiento.o asiento.cpp

${OBJECTDIR}/listaEspera.o: listaEspera.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/listaEspera.o listaEspera.cpp

${OBJECTDIR}/listaGeneral.o: listaGeneral.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/listaGeneral.o listaGeneral.cpp

${OBJECTDIR}/listaPreferencial.o: listaPreferencial.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/listaPreferencial.o listaPreferencial.cpp

${OBJECTDIR}/listaSolicitud.o: listaSolicitud.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/listaSolicitud.o listaSolicitud.cpp

${OBJECTDIR}/listaVIP.o: listaVIP.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/listaVIP.o listaVIP.cpp
...
${OBJECTDIR}/nodoAsiento.o: nodoAsiento.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nodoAsiento.o nodoAsiento.cpp

${OBJECTDIR}/nodoEspera.o: nodoEspera.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nodoEspera.o nodoEspera.cpp
...
${OBJECTDIR}/nodoSolicitud.o: nodoSolicitud.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nodoSolicitud.o nodoSolicitud.cpp

${OBJECTDIR}/pilaAsiento.o: pilaAsiento.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pilaAsiento.o pilaAsiento.cpp
